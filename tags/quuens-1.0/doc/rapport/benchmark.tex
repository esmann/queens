...
Java koden er oversat med javac
...
C koden er oversat med \texttt{gcc -O2 -o nq nqueens.c}
...
I de første test der brugt \texttt{int} til resultaterne i java-koden. 
...
loop'et kan optimeres Det skal dog nævnes, at med $maxSteps>0$ får vi færre
...
\subsection{Andel af hjørnebræt i forhold til midterbræt}
...
(se tabel \ref{tabel:boardgenerering}. Langt den største del af tiden går også med
...
vi så får 289 jobs, giver det knap 89 minutter ved kørsel på én ressource. En del af dette overhead vil selvfølgelig blive "gemt", når der er flere ressourcer der kører samtidigt.
