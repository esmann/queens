...
public class Applet extends java.applet.Applet {
	...
	public void init() {
		...
		System.out.println("resource_name: "
				+ this.getParameter("resource_name"));
		System.out.println("cputime: " + this.getParameter("cputime"));

		try {
			// this.exe = new Exe(thisthis.getParameter("server"),
			// this.getParameter("sandboxkey"),
			// this.getParameter("resource_name"));
			this.resource = new Resource(this);

			// this.getParameter("server"), this.getParameter("sandboxkey"),
			// this.getParameter("resource_name"));
	...
	public void paint(Graphics g) {
		...
		buffer_g.drawString("MiG Resource: " + this.resource_name, 15, 30); // draw
																			// the
																			// message
		buffer_g.drawString("MiG Server: " + this.server, 15, 55); // draw the
																	// message

		buffer_g.drawString("MiG Status: " + this.status_msg, 15, 80); // draw
																		// the
																		// message
		buffer_g.drawString("MiG Jobs done: " + this.jobs_done, 15, 105); // draw
																			// the
																			// message
		buffer_g.drawString("MiG Jobs failed: " + this.jobs_failed, 15, 130); // draw
																				// the
																				// message
	...
	/*
	 * This method gets called when the applet is terminated-- when the user
	 * goes to another page or exits the browser.
	 */
	public void stop() {
	...
	/*
	 * method destroy desription: to destroy the applet
	 */
	public void destroy() {
