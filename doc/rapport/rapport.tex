...
\draw[->] (-1.25,-1.75) -- node[draw=none,below=0.5em]{Hastighed} (2,-1.75);
\draw[->] (-1.75,-1.25) -- node[draw=none,left=0.5em]{Jobstørrelse} (-1.75,2);

\end{tikzpicture}		
\caption{Illustration af både ressource hastighed og job størrelse variere. Arealet er beregningstiden} 
\end{center}
\end{figure}
...
skyldes at checkpoint ikke gemmer kaldstack og programtæller, så vi ville ikke
...
Disse 2 klasser bliver brugt til at lave checkpoints
