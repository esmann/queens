...
Den første placering \footnote{For hjørnebræt er dette række 2, fordi den første dronning skal være placeret i hjørnet} af en dronning bestemmer hvilke valg vi kan undgå,\emph{bounds}, og dermed mængden af deltræ vi kan fjerne. Derfor vil der være forskel på andelen af løsninger som set på figur \ref{fig:midterandel}. Sammenholdt med figur\ref{fig:tidsvssol} kan vi se at antallet af forholdet mellem antallet af løsninger ca. angiver forholdet mellem beregningstiden af to bræt.
...
\hline  & int & long & bigint \\
\hline rekursiv & 406.065 & 403.178 & 414.238 \\
\hline iterativ & 700.887 & 714.718 & 736.157 \\
\hline
\end{tabular}
\caption{Sammenligning af kørsler med int, long og BigInteger}
\end{center}
\end{table}
