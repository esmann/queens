...
\fixme{flyttes til afsnit \ref{mig}}
...
\begin{itemize}
	...
	\item Pladsforbrug for resultater, checkpoints(13 cpu-år * checkpoint hvert kvarter), job
	\item 
\end{itemize}
...
I en implementation med \texttt{java.Math.BigInteger} kan vi se at der vil være et performance tab på 2\% i forhold til brugen af af den primitive type \textt{long} \fixme{Tabel med TidLong TidBiginter og ProcentForøgelse}. 
...
\begin{Description}
	\item[Job fejler ikke hvis der kastes en kastes en \texttt{java.lang.Error}]  Java har både \textt{Exceptions} og \textt{Error} der begge er af typen{java.lang.Throwable}. \oc griber kun \textt{Exceptions} som \oc og rapportere som at jobbet er succesfuldt afsluttet. Dette kan  
