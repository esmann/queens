...
\nq\ består i at finde antallet af måder man kan placere N dronninger på et et kvadratisk NxN bræt, således at ingen dronning kan slå en anden. Bemærk at vi skal finde alle løsninger $Q(n)$, og ikke bare finde alle løsninger - hvilket er et helt andet problem. Hidtil er der kun fundet løsninger for $n \in \{1,...,25\}$.\cite{sekvenser}. Derudover beskriver \cite{etsi} en manuelt distribueret løsning for $n=25$. Der findes desuden masser af referencer på \url{http://www.liacs.nl/home/kosters/nqueens.html} relateret til \nq. 
...
En simpel øvre grænse for \nq\ ses ved at der ikke kan placeres to dronninger på samme række eller kolonne. En løsning består altså af n forskellige dronninger hvor ingen må være på samme kolonne. Løsningen i \ref{fig:nq5eks} kan så noteres som en \textit{opstillingsvektor} $24153$. Alle mulige opstillinger svarer altså til permutationer af ${1,\ldots,n}$. En brute force metode er så at checke alle mulige permutationer for at se om de er tilladte opstillinger.

Til kombinatoriske problemer bruges ofte backtracking. Backtracking gennemløber en permutering af opstillingsvektoren  $(P_1,\ldots..P_k)$ dybde-først, og undlader valg som ikke er gyldige. For \nq\ vedligeholdes en stak $(P_1,\ldots..P_k)$ over gennemløbet. Backtracking er yderlige beskrevet i \cite{Golomb72}.
...
Dette kan visualiseres med et træ. Knuder angiver den valgte placering, mens kanter angiver de mulige beslutninger el. valg der kan foretages.  Træet har en maksimal højde på $n$. Hvor højden for roden er 0. Antallet af børn er antallet af \textit{mulige} valg som ikke blokeres af tidligere placeringer. 
...
For $Q(n)$ er mange løsninger reflektioner og roteringer af andre - og betragtes som en \textit{unik} løsning. Ved kun at betragte unikke løsninger kan vi mindste antallet af blade i vores beslutnings-træ \ref{fig:tree} til antallet af unikke løsninger, $S(n)$ og dermed mindske beregnings tiden. I tabel \fixme{Tabel over Unikke løsninger vs. Totale antal løsninger} ses forskellen på antallet af unikke og totale løsninger. For hver løsning undersøges antallet af reflektioner og rotationer. Check funktion  \ref{nqueen.c} udfører dette.

Takaken opdeler beregningen i to delproblemer. Et hvor den første dronning placeres i øverste hjørne, og et andet delproblem hvor dronningen i den første række kan placeres i kolonnen $n/2 til 2$. 
...
\oc\ indeholder jave-klasser til læsning og skrivning af filer i \mig\-hjemmekataloget, 
