public class NQueensL {
	public static void NQueensL(int size)// {{{
	{
		...
		for (Globals.Bound1 = 2; Globals.Bound1 < Globals.SizeE; Globals.Bound1++) {
			...
			// Her skal Bound1 gives med som argument saa man kan lave alle
			// kaldene i for loopet parallelt.
	...
	public static void BackTrack1(int y, int left, int down, int right)// {{{
	{
		...
		// left, down, right er de steder hvor der ikke kan staa noget (ie der
		// staar allerede noget og spaerrer)
	...
	public static void main(String[] args)// {{{
	{
		...
		System.out.println(Globals.Size + ": " + Globals.Total + " "
				+ Globals.Unique + " " + (time / 1000));
