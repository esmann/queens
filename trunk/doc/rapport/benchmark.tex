...
\end{description}
\fixme{referencer til ovenstående? skal de beskrives yderligere}
...
er lavet, men hvordan viser man det smartest, en stor tabel eller graf?}
\fixme{Antallet af jobs er gentagelse fra 1.3/1.4.. Er det?}
...
\fixme{Det ikke interessant at finde køretiden for den første Queued til den
sidste Finished. Hvorfor ikke? det er da ret interessant hvor lang tid det tager
at løse problemet, og hvor meget man kan blive buttfucked i \mig s køsystem}
